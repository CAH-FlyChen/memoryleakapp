...
namespace MemoryLeakTest.EntityFrameworkCore
{
    ...
    public class MemoryLeakTestMigrationsDbContextFactory : IDesignTimeDbContextFactory<MemoryLeakTestMigrationsDbContext>
    {
        ...
        private static IConfigurationRoot BuildConfiguration()
        {
            var builder = new ConfigurationBuilder()
                .SetBasePath(Path.Combine(Directory.GetCurrentDirectory(), "../MemoryLeakTest.DbMigrator/"))
