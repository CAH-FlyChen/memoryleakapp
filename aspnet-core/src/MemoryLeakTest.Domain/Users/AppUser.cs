...
namespace MemoryLeakTest.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update MemoryLeakTestDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update MemoryLeakTestEfCoreEntityExtensionMappings to extend the IdentityUser entity
