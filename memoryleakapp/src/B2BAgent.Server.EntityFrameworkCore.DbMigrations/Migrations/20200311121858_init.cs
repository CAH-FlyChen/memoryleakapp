    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_business_tenant", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
                    ErpType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_erp", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "biz_sync_package",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    JobName = table.Column<string>(nullable: true),
                    ExtDataType = table.Column<string>(nullable: true),
                    ExtData = table.Column<string>(nullable: true),
                    DataStartTime = table.Column<DateTime>(nullable: false),
                    DataEndTime = table.Column<DateTime>(nullable: false),
                    Type = table.Column<string>(nullable: true),
                    Body = table.Column<byte[]>(nullable: true),
                    Protocal = table.Column<string>(nullable: true),
                    FileCreateDate = table.Column<DateTime>(nullable: false),
                    Sign = table.Column<string>(nullable: true),
                    CreationTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_sync_package", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "biz_sync_package_data",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_sync_package_data", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ext = table.Column<string>(maxLength: 5, nullable: false),
                    FilePath = table.Column<string>(maxLength: 5000, nullable: false),
                    GuidName = table.Column<string>(maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EVAttachment", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EVUser", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "biz_erp_verison",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    VersionString = table.Column<string>(maxLength: 20, nullable: false),
                    ERPId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_erp_verison", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_erp_verison_biz_erp_ERPId",
                        column: x => x.ERPId,
                        principalTable: "biz_erp",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "biz_agent_client",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                    ...
                    DeleterId = table.Column<Guid>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    VersionString = table.Column<string>(maxLength: 20, nullable: true),
                    Version = table.Column<int>(nullable: false),
                    EVAttachmentId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_agent_client", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_agent_client_EVAttachment_EVAttachmentId",
                        column: x => x.EVAttachmentId,
                        principalTable: "EVAttachment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "biz_agent_config",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CreationTime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_agent_config", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_agent_config_EVAttachment_EVAttachmentId",
                        column: x => x.EVAttachmentId,
                        principalTable: "EVAttachment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_watcher_client", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_watcher_client_EVAttachment_EVAttachmentId",
                        column: x => x.EVAttachmentId,
                        principalTable: "EVAttachment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterId = table.Column<Guid>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    SysDictId = table.Column<Guid>(nullable: true),
                    Name = table.Column<string>(maxLength: 50, nullable: true),
                    Code = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeleterId = table.Column<Guid>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    ERPVersionId = table.Column<Guid>(nullable: false),
                    ConfigData = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_config_template", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_config_template_biz_erp_verison_ERPVersionId",
                        column: x => x.ERPVersionId,
                        principalTable: "biz_erp_verison",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentConfigId = table.Column<Guid>(nullable: true),
                    AgentClientId = table.Column<Guid>(nullable: true),
                    WatcherClientId = table.Column<Guid>(nullable: true),
                    BusinessTenantId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_agent_merchant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_biz_agent_client_AgentClientId",
                        column: x => x.AgentClientId,
                        principalTable: "biz_agent_client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_biz_agent_config_AgentConfigId",
                        column: x => x.AgentConfigId,
                        principalTable: "biz_agent_config",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_biz_business_tenant_BusinessTenantId",
                        column: x => x.BusinessTenantId,
                        principalTable: "biz_business_tenant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_biz_erp_verison_ERPVersionId",
                        column: x => x.ERPVersionId,
                        principalTable: "biz_erp_verison",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_Sys_DictItem_OSId",
                        column: x => x.OSId,
                        principalTable: "Sys_DictItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_biz_agent_merchant_biz_watcher_client_WatcherClientId",
                        column: x => x.WatcherClientId,
                        principalTable: "biz_watcher_client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_biz_sync_log", x => x.Id);
                    table.ForeignKey(
                        name: "FK_biz_sync_log_biz_agent_merchant_MerchantId",
                        column: x => x.MerchantId,
                        principalTable: "biz_agent_merchant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_client_EVAttachmentId",
                table: "biz_agent_client",
                column: "EVAttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_config_EVAttachmentId",
                table: "biz_agent_config",
                column: "EVAttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_AgentClientId",
                table: "biz_agent_merchant",
                column: "AgentClientId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_AgentConfigId",
                table: "biz_agent_merchant",
                column: "AgentConfigId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_BusinessTenantId",
                table: "biz_agent_merchant",
                column: "BusinessTenantId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_ERPVersionId",
                table: "biz_agent_merchant",
                column: "ERPVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_OSId",
                table: "biz_agent_merchant",
                column: "OSId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_agent_merchant_WatcherClientId",
                table: "biz_agent_merchant",
                column: "WatcherClientId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_config_template_ERPVersionId",
                table: "biz_config_template",
                column: "ERPVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_erp_verison_ERPId",
                table: "biz_erp_verison",
                column: "ERPId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_sync_log_MerchantId",
                table: "biz_sync_log",
                column: "MerchantId");

            migrationBuilder.CreateIndex(
                name: "IX_biz_watcher_client_EVAttachmentId",
                table: "biz_watcher_client",
                column: "EVAttachmentId");
